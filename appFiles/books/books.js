                    ...
                    <div class="book-stall">
                        <div class="book-stallBook">
                            <div class="bookImg-stall">
                                <img class="nimona" src="http://surl.li/gaxns">
                        ...
                        <div class="book-stallBook">
                            <div class="bookImg-stall">
                            <img  class="Cemetery" src="http://surl.li/gaxly">
                                <div class="boomImg-name">
                                Cemetery Boys
                                </div>
                                <div class="boomImg-authorName">
                        ...
                        <div class="book-stallBook">
                            <div class="bookImg-stall">
                            <img  class="legend" src="http://surl.li/gaxlg">
                                <div class="boomImg-name">
                                One Piece
                                </div>
                                <div class="boomImg-authorName">
                        ...
                        <div class="book-stallBook">
                            <div class="bookImg-stall">
                            <img class="alchemist"  src="http://surl.li/gaxoy">
                                <div class="boomImg-name">
                                The Alchemist
                                </div>
                                <div class="boomImg-authorName">
                        ...
                        <div class="book-stallBook">
                            <div class="bookImg-stall">
                                <img class="weAreOkay" src="http://surl.li/gaxqr">
                                <div class="boomImg-name">
                                We Are Okay
                                </div>
                                <div class="boomImg-authorName">
                        ...
                        <div class="book-stallBook">
                            <div class="bookImg-stall">
                            <img class="flame"  src="http://surl.li/gaxrz">
                                <div class="boomImg-name">
                                We Hunt the Flame
                                </div>
                                <div class="boomImg-authorName">
